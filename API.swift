...
public struct CreateUserInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID? = nil, username: String, isSafe: Bool? = nil, version: Int? = nil) {
    graphQLMap = ["id": id, "username": username, "isSafe": isSafe, "_version": version]
  }
  ...
  public var isSafe: Bool? {
    get {
      return graphQLMap["isSafe"] as! Bool?
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "isSafe")
    }
  }
...
public struct ModelUserConditionInput: GraphQLMapConvertible {
  ...
  public init(username: ModelStringInput? = nil, isSafe: ModelBooleanInput? = nil, and: [ModelUserConditionInput?]? = nil, or: [ModelUserConditionInput?]? = nil, not: ModelUserConditionInput? = nil) {
    graphQLMap = ["username": username, "isSafe": isSafe, "and": and, "or": or, "not": not]
  }
  ...
  public var isSafe: ModelBooleanInput? {
    get {
      return graphQLMap["isSafe"] as! ModelBooleanInput?
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "isSafe")
    }
...
public struct UpdateUserInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID, username: String? = nil, isSafe: Bool? = nil, version: Int? = nil) {
    graphQLMap = ["id": id, "username": username, "isSafe": isSafe, "_version": version]
  }
...
public struct ModelUserFilterInput: GraphQLMapConvertible {
  ...
  public init(id: ModelIDInput? = nil, username: ModelStringInput? = nil, isSafe: ModelBooleanInput? = nil, and: [ModelUserFilterInput?]? = nil, or: [ModelUserFilterInput?]? = nil, not: ModelUserFilterInput? = nil) {
    graphQLMap = ["id": id, "username": username, "isSafe": isSafe, "and": and, "or": or, "not": not]
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateUser: GraphQLSelectionSet {
      ...
      public static let selections: [GraphQLSelection] = [
        ...
        GraphQLField("isSafe", type: .scalar(Bool.self)),
      ...
      public init(id: GraphQLID, username: String, isSafe: Bool? = nil, version: Int, deleted: Bool? = nil, lastChangedAt: Int, createdAt: String, updatedAt: String) {
        self.init(snapshot: ["__typename": "User", "id": id, "username": username, "isSafe": isSafe, "_version": version, "_deleted": deleted, "_lastChangedAt": lastChangedAt, "createdAt": createdAt, "updatedAt": updatedAt])
      }
      ...
      public var isSafe: Bool? {
        get {
          return snapshot["isSafe"] as? Bool
        }
        set {
          snapshot.updateValue(newValue, forKey: "isSafe")
        }
      }
